...
const createCircleIcon = (color = 'green', borderColor = 'black') =>
  L.divIcon({
        ...
        <>
          ...
          {coords.map((coord, index) => (
            <Marker
              ...
              position={coord}
              icon={
                selectedMarkerIndex === index ? selectedCircleIcon : circleIcon
              }
              draggable
            ...
            >
              {selectedMarkerIndex === index && (
                <L.Tooltip direction="top" offset={[0, -10]} permanent>
                  {' '}
                  {/* Using L.Tooltip directly */}
